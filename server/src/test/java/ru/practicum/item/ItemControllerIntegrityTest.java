...
public class ItemControllerIntegrityTest {
    @Autowired
    ...
    void createItemNotValid() {
        Item item = Item.builder().id(1L).name("asd").available(true).build();
        Item item1 = Item.builder().id(2L).name("asd").description("asdf").build();
        Item item2 = Item.builder().id(3L).available(true).description("asdf").build();
